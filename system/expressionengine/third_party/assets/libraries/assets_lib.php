...
class Assets_lib
{
	...
	public function get_files($params)
	{
		...
		$files = $this->_get_files($params['folders'], $params['keywords'], $params['kinds'], $params['search_type'], $params['limit'], $params['offset']);
	 ...
	 * @return array
	 */
	private function _get_files($folders, $keywords = '', $kinds = 'any', $search_type, $limit = 0, $offset = 0)
	{
		if (empty($limit))
		{
		...
		return array_slice($files, (int) $offset, (int) $limit);
	}
