...
*/
		...
		<script type="text/javascript">
			var cpnav_settings = {
				...
				"ajax_preview_method": "' . $script_name . '?S=0&D=cp&C=addons_modules&M=show_module_cp&module=zoo_flexible_admin&method=action&func=ajax_preview",
				"ajax_load_tree": ' . $this->EE->cp->fetch_action_id('Zoo_flexible_admin', 'ajax_load_tree') . ',
				"ajax_load_tree_method": "' . $script_name . '?S=0&D=cp&C=addons_modules&M=show_module_cp&module=zoo_flexible_admin&method=action&func=ajax_load_tree",
				"ajax_load_settings": ' . $this->EE->cp->fetch_action_id('Zoo_flexible_admin', 'ajax_load_settings') . ',
				"ajax_load_settings_method": "' . $script_name . '?S=0&D=cp&C=addons_modules&M=show_module_cp&module=zoo_flexible_admin&method=action&func=ajax_load_settings",
				"ajax_save": ' . $this->EE->cp->fetch_action_id('Zoo_flexible_admin', 'ajax_save_tree') . ',
				"ajax_save_method": "' . $script_name . '?S=0&D=cp&C=addons_modules&M=show_module_cp&module=zoo_flexible_admin&method=action&func=ajax_save_tree",
				"ajax_copy": ' . $this->EE->cp->fetch_action_id('Zoo_flexible_admin', 'ajax_copy_tree') . ',
				"ajax_copy_method": "' . $script_name . '?S=0&D=cp&C=addons_modules&M=show_module_cp&module=zoo_flexible_admin&method=action&func=ajax_copy_tree",
				"ajax_remove": ' . $this->EE->cp->fetch_action_id('Zoo_flexible_admin', 'ajax_remove_tree') . ',
				"ajax_remove_method": "' . $script_name . '?S=0&D=cp&C=addons_modules&M=show_module_cp&module=zoo_flexible_admin&method=action&func=ajax_remove_tree",
				...
				"br_pages" : \''.$this->EE->javascript->generate_json($this->getBR(), TRUE).'\',
	...
	function getBR(){
		...
		$methods = array("" => "Dashboard","customer" => "Customers","order"=>"Orders","product"=>"Products","promo"=>"Promotions","report"=>"Reports","config"=>"Settings");
